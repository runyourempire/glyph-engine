// GAME Component: cond-test2 — auto-generated, do not edit.
(function(){
...
`;
const UNIFORMS = [{name:'critical_count',default:0},{name:'heat',default:0}];
...
class CondTest2 extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-cond-test2: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-cond-test2', CondTest2);
})();
