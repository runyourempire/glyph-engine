// GAME Component: dawn — auto-generated, do not edit.
(function(){
...
class Dawn extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-dawn: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-dawn', Dawn);
})();
