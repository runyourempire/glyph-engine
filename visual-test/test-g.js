// GAME Component: test-g — auto-generated, do not edit.
(function(){
...
class TestG extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-test-g: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-test-g', TestG);
})();
