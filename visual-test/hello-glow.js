// GAME Component: hello-glow — auto-generated, do not edit.
(function(){
...
class HelloGlow extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-hello-glow: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-hello-glow', HelloGlow);
})();
