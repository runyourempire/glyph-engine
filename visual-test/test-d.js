// GAME Component: test-d — auto-generated, do not edit.
(function(){
...
class TestD extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-test-d: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-test-d', TestD);
})();
