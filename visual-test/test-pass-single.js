// GAME Component: test-pass-single — auto-generated, do not edit.
(function(){
...
class TestPassSingle extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-test-pass-single: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-test-pass-single', TestPassSingle);
})();
