// GLYPH Component: dendrite — auto-generated, do not edit.
(function(){
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('glyph-dendrite: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('glyph-dendrite', Dendrite);
})();
