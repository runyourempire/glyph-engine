...
/**
 * `<glyph-event-horizon>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-event-horizon color_r="0.3" color_g="0.8" color_b="1.5"></glyph-event-horizon>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-event-horizon')!;
   * el.color_r = 0.3;
   * el.color_g = 0.8;
 * ```
 */
interface GameEventHorizonElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-event-horizon': GameEventHorizonElement;
  }
}
