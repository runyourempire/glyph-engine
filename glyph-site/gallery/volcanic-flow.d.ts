...
/**
 * `<glyph-volcanic-flow>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-volcanic-flow life="0" warmth="0"></glyph-volcanic-flow>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-volcanic-flow')!;
   * el.life = 0;
   * el.warmth = 0;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-volcanic-flow': GameVolcanicFlowElement;
  }
}
