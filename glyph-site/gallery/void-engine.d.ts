...
/**
 * `<glyph-void-engine>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-void-engine pulse="0" awareness="0.3" depth="0.5"></glyph-void-engine>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-void-engine')!;
   * el.pulse = 0;
   * el.awareness = 0.3;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-void-engine': GameVoidEngineElement;
  }
}
