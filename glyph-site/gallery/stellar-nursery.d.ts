...
/**
 * `<glyph-stellar-nursery>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-stellar-nursery formation="0" radiation="0.4"></glyph-stellar-nursery>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-stellar-nursery')!;
   * el.formation = 0;
   * el.radiation = 0.4;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-stellar-nursery': GameStellarNurseryElement;
  }
}
