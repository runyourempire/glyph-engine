...
/**
 * `<glyph-silk-void>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-silk-void shimmer="0" weave_speed="0.25"></glyph-silk-void>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-silk-void')!;
   * el.shimmer = 0;
   * el.weave_speed = 0.25;
 * ```
 */
interface GameSilkVoidElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-silk-void': GameSilkVoidElement;
  }
}
