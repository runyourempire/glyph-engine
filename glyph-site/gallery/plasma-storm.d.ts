...
/**
 * `<glyph-plasma-storm>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-plasma-storm voltage="0.6" discharge="0"></glyph-plasma-storm>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-plasma-storm')!;
   * el.voltage = 0.6;
   * el.discharge = 0;
 * ```
 */
interface GamePlasmaStormElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-plasma-storm': GamePlasmaStormElement;
  }
}
