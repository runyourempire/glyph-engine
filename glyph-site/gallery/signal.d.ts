...
/**
 * `<glyph-signal>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-signal pulse="0.3"></glyph-signal>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-signal')!;
   * el.pulse = 0.3;
 * ```
 */
interface GameSignalElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-signal': GameSignalElement;
  }
}
