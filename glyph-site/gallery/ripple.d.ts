...
/**
 * `<glyph-ripple>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-ripple expand="0"></glyph-ripple>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-ripple')!;
   * el.expand = 0;
 * ```
 */
interface GameRippleElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-ripple': GameRippleElement;
  }
}
