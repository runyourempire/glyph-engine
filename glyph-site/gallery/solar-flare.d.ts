...
/**
 * `<glyph-solar-flare>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-solar-flare eruption="0" corona="0.4"></glyph-solar-flare>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-solar-flare')!;
   * el.eruption = 0;
   * el.corona = 0.4;
 * ```
 */
interface GameSolarFlareElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-solar-flare': GameSolarFlareElement;
  }
}
