...
/**
 * `<glyph-ocean-alive>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-ocean-alive life="0" warmth="0"></glyph-ocean-alive>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-ocean-alive')!;
   * el.life = 0;
   * el.warmth = 0;
 * ```
 */
interface GameOceanAliveElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-ocean-alive': GameOceanAliveElement;
  }
}
