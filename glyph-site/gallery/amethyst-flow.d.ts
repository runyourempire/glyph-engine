...
/**
 * `<glyph-amethyst-flow>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-amethyst-flow life="0" warmth="0"></glyph-amethyst-flow>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-amethyst-flow')!;
   * el.life = 0;
   * el.warmth = 0;
 * ```
 */
interface GameAmethystFlowElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-amethyst-flow': GameAmethystFlowElement;
  }
}
