...
/**
 * `<glyph-ember-flow>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-ember-flow heat="0" viscosity="0.28"></glyph-ember-flow>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-ember-flow')!;
   * el.heat = 0;
   * el.viscosity = 0.28;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-ember-flow': GameEmberFlowElement;
  }
}
