...
/**
 * `<glyph-bioluminescent-abyss>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-bioluminescent-abyss depth="0.5" pulse="0"></glyph-bioluminescent-abyss>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-bioluminescent-abyss')!;
   * el.depth = 0.5;
   * el.pulse = 0;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-bioluminescent-abyss': GameBioluminescentAbyssElement;
  }
}
