...
/**
 * `<glyph-labyrinth>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-labyrinth color_r="1.2" color_g="1.2" color_b="1.4"></glyph-labyrinth>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-labyrinth')!;
   * el.color_r = 1.2;
   * el.color_g = 1.2;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-labyrinth': GameLabyrinthElement;
  }
}
