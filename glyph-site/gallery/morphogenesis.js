// GLYPH Component: morphogenesis — auto-generated, do not edit.
(function(){
...
void main(){
    ...
    color_result = vec4(color_result.rgb * vec3(0.008000, 0.020000, 0.030000), color_result.a);
...
`;
const UNIFORMS = [{name:'color_r',default:0.2},{name:'color_g',default:1},{name:'color_b',default:1.4}];
...
class GameReactionField {
  ...
  dispatch(steps = 8) {
    ...
    f[0] = 0.034 + Math.sin(t * 0.7) * 0.001 - dissolve * 0.03;
    f[1] = 0.059 + Math.cos(t * 0.5) * 0.0005 + dissolve * 0.02;
    f[2] = 1; f[3] = 0.5;
...
class Morphogenesis extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('glyph-morphogenesis: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
  ...
  get color_g() { return this._renderer?.userParams['color_g'] ?? this._pendingParams['color_g'] ?? 1; }
...
customElements.define('glyph-morphogenesis', Morphogenesis);
})();
