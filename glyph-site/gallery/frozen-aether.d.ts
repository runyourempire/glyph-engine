...
/**
 * `<glyph-frozen-aether>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-frozen-aether thaw="0" shimmer="0.3"></glyph-frozen-aether>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-frozen-aether')!;
   * el.thaw = 0;
   * el.shimmer = 0.3;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-frozen-aether': GameFrozenAetherElement;
  }
}
