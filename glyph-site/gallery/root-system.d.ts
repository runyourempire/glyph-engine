...
/**
 * `<glyph-root-system>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-root-system color_r="0.2" color_g="1.2" color_b="0.3"></glyph-root-system>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-root-system')!;
   * el.color_r = 0.2;
   * el.color_g = 1.2;
 * ```
 */
interface GameRootSystemElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-root-system': GameRootSystemElement;
  }
}
