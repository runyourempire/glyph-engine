...
/**
 * `<glyph-supernova>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-supernova detonation="0" shockwave="0"></glyph-supernova>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-supernova')!;
   * el.detonation = 0;
   * el.shockwave = 0;
 * ```
 */
interface GameSupernovaElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-supernova': GameSupernovaElement;
  }
}
