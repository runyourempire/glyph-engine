...
/**
 * `<glyph-dendrite>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-dendrite color_r="0.9" color_g="0.2" color_b="1.4"></glyph-dendrite>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-dendrite')!;
   * el.color_r = 0.9;
   * el.color_g = 0.2;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-dendrite': GameDendriteElement;
  }
}
