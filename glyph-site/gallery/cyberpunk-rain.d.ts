...
/**
 * `<glyph-cyberpunk-rain>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-cyberpunk-rain downpour="0" neon="0.5"></glyph-cyberpunk-rain>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-cyberpunk-rain')!;
   * el.downpour = 0;
   * el.neon = 0.5;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-cyberpunk-rain': GameCyberpunkRainElement;
  }
}
