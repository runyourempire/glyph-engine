...
/**
 * `<glyph-discharge>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-discharge color_r="1.1" color_g="1.2" color_b="1.5"></glyph-discharge>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-discharge')!;
   * el.color_r = 1.1;
   * el.color_g = 1.2;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-discharge': GameDischargeElement;
  }
}
