...
/**
 * `<glyph-deep-current>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-deep-current flow_speed="0.3" bio_glow="0"></glyph-deep-current>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-deep-current')!;
   * el.flow_speed = 0.3;
   * el.bio_glow = 0;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-deep-current': GameDeepCurrentElement;
  }
}
