...
/**
 * `<glyph-singularity>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <glyph-singularity awakening="0" depth="0"></glyph-singularity>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('glyph-singularity')!;
   * el.awakening = 0;
   * el.depth = 0;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'glyph-singularity': GameSingularityElement;
  }
}
