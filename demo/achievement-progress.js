// GAME Component: achievement-progress — auto-generated, do not edit.
(function(){
...
`;
const UNIFORMS = [{name:'charcoal',default:0.3},{name:'fill_angle',default:0},{name:'glow_val',default:2},{name:'gold',default:0.83}];
...
class AchievementProgress extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-achievement-progress: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-achievement-progress', AchievementProgress);
})();
