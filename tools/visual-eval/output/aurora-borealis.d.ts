...
/**
 * `<game-aurora-borealis>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-aurora-borealis activity="0.5" curtain="0"></game-aurora-borealis>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-aurora-borealis')!;
   * el.activity = 0.5;
   * el.curtain = 0;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-aurora-borealis': GameAuroraBorealisElement;
  }
}
