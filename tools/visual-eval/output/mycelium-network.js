// GAME Component: mycelium-network — auto-generated, do not edit.
(function(){
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-mycelium-network: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-mycelium-network', MyceliumNetwork);
})();
