// GAME Component: digital-consciousness — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    // ── Layer 2: circuit ──
    {
        ...
        let gx = abs(game_mod(p.x + 0.060000 * 0.5, 0.060000) - 0.060000 * 0.5) - 0.001000;
        let gy = abs(game_mod(p.y + 0.060000 * 0.5, 0.060000) - 0.060000 * 0.5) - 0.001000;
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-digital-consciousness: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-digital-consciousness', DigitalConsciousness);
})();
