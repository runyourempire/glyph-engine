// GAME Component: quantum-flux — auto-generated, do not edit.
(function(){
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-quantum-flux: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-quantum-flux', QuantumFlux);
})();
