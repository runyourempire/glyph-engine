...
/**
 * `<game-silk-void>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-silk-void shimmer="0" weave_speed="0.25"></game-silk-void>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-silk-void')!;
   * el.shimmer = 0;
   * el.weave_speed = 0.25;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-silk-void': GameSilkVoidElement;
  }
}
