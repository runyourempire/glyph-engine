...
/**
 * `<game-deep-coral>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-deep-coral color_r="0.3" color_g="0.6" color_b="1.5"></game-deep-coral>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-deep-coral')!;
   * el.color_r = 0.3;
   * el.color_g = 0.6;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-deep-coral': GameDeepCoralElement;
  }
}
