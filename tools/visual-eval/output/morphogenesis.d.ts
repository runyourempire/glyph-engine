...
/**
 * `<game-morphogenesis>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-morphogenesis color_r="0.2" color_g="1" color_b="1.4"></game-morphogenesis>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-morphogenesis')!;
   * el.color_r = 0.2;
   * el.color_g = 1;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-morphogenesis': GameMorphogenesisElement;
  }
}
