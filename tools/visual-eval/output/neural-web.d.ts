...
/**
 * `<game-neural-web>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-neural-web signal="0" plasticity="0.3"></game-neural-web>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-neural-web')!;
   * el.signal = 0;
   * el.plasticity = 0.3;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-neural-web': GameNeuralWebElement;
  }
}
