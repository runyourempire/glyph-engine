// GAME Component: deep-current — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    // ── Layer 3: organisms ──
    {
        ...
        p = vec2<f32>(game_mod(p.x + 0.130000 * 0.5, 0.130000) - 0.130000 * 0.5, game_mod(p.y + 0.130000 * 0.5, 0.130000) - 0.130000 * 0.5);
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-deep-current: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-deep-current', DeepCurrent);
})();
