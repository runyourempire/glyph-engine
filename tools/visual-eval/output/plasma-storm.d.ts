...
/**
 * `<game-plasma-storm>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-plasma-storm voltage="0.6" discharge="0"></game-plasma-storm>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-plasma-storm')!;
   * el.voltage = 0.6;
   * el.discharge = 0;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-plasma-storm': GamePlasmaStormElement;
  }
}
