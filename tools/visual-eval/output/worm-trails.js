// GAME Component: worm-trails — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    color_result = vec4<f32>(color_result.rgb * vec3<f32>(0.020000, 0.000000, 0.030000), color_result.a);
...
void main(){
    ...
    color_result = vec4(color_result.rgb * vec3(0.020000, 0.000000, 0.030000), color_result.a);
...
class GameReactionField {
  ...
  dispatch(steps = 8) {
    ...
    f[0] = 0.046 + Math.sin(t * 0.7) * 0.001 - dissolve * 0.03;
    f[1] = 0.063 + Math.cos(t * 0.5) * 0.0005 + dissolve * 0.02;
    f[2] = 1; f[3] = 0.5;
...
class WormTrails extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-worm-trails: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-worm-trails', WormTrails);
})();
