...
/**
 * `<game-volcanic-core>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-volcanic-core pressure="0" heat="0.6"></game-volcanic-core>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-volcanic-core')!;
   * el.pressure = 0;
   * el.heat = 0.6;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-volcanic-core': GameVolcanicCoreElement;
  }
}
