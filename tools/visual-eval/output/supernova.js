// GAME Component: supernova — auto-generated, do not edit.
(function(){
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-supernova: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-supernova', Supernova);
})();
