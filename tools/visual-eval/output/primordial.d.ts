...
/**
 * `<game-primordial>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-primordial ignition="0" expansion="0" consciousness="0"></game-primordial>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-primordial')!;
   * el.ignition = 0;
   * el.expansion = 0;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-primordial': GamePrimordialElement;
  }
}
