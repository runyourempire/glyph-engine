...
/**
 * `<game-mycelium-network>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-mycelium-network growth="0" nutrient="0.3"></game-mycelium-network>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-mycelium-network')!;
   * el.growth = 0;
   * el.nutrient = 0.3;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-mycelium-network': GameMyceliumNetworkElement;
  }
}
