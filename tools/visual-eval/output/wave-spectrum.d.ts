...
/**
 * `<game-wave-spectrum>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GameWaveSpectrumElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-wave-spectrum': GameWaveSpectrumElement;
  }
}
