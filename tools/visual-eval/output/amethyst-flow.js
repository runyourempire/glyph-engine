// GAME Component: amethyst-flow — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    // ── Layer 2: nodes ──
    {
        ...
        p = vec2<f32>(game_mod(p.x + 0.150000 * 0.5, 0.150000) - 0.150000 * 0.5, game_mod(p.y + 0.150000 * 0.5, 0.150000) - 0.150000 * 0.5);
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-amethyst-flow: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-amethyst-flow', AmethystFlow);
})();
