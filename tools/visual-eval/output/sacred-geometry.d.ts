...
/**
 * `<game-sacred-geometry>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-sacred-geometry breath="0"></game-sacred-geometry>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-sacred-geometry')!;
   * el.breath = 0;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-sacred-geometry': GameSacredGeometryElement;
  }
}
