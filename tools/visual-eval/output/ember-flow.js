// GAME Component: ember-flow — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    // ── Layer 4: embers ──
    {
        ...
        p = vec2<f32>(game_mod(p.x + 0.100000 * 0.5, 0.100000) - 0.100000 * 0.5, game_mod(p.y + 0.100000 * 0.5, 0.100000) - 0.100000 * 0.5);
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-ember-flow: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-ember-flow', EmberFlow);
})();
