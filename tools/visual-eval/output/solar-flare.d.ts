...
/**
 * `<game-solar-flare>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-solar-flare eruption="0" corona="0.4"></game-solar-flare>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-solar-flare')!;
   * el.eruption = 0;
   * el.corona = 0.4;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-solar-flare': GameSolarFlareElement;
  }
}
