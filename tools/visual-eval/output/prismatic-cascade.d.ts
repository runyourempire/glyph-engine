...
/**
 * `<game-prismatic-cascade>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-prismatic-cascade refraction="0" intensity="0.5"></game-prismatic-cascade>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-prismatic-cascade')!;
   * el.refraction = 0;
   * el.intensity = 0.5;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-prismatic-cascade': GamePrismaticCascadeElement;
  }
}
