// GAME Component: sacred-geometry — auto-generated, do not edit.
(function(){
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-sacred-geometry: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-sacred-geometry', SacredGeometry);
})();
