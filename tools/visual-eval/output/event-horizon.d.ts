...
/**
 * `<game-event-horizon>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-event-horizon color_r="0.3" color_g="0.8" color_b="1.5"></game-event-horizon>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-event-horizon')!;
   * el.color_r = 0.3;
   * el.color_g = 0.8;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-event-horizon': GameEventHorizonElement;
  }
}
