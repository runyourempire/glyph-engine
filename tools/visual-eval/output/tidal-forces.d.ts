...
/**
 * `<game-tidal-forces>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-tidal-forces pull="0" swell="0.3"></game-tidal-forces>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-tidal-forces')!;
   * el.pull = 0;
   * el.swell = 0.3;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-tidal-forces': GameTidalForcesElement;
  }
}
