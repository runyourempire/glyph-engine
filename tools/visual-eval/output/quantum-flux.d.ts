...
/**
 * `<game-quantum-flux>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-quantum-flux coherence="0" entanglement="0.3"></game-quantum-flux>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-quantum-flux')!;
   * el.coherence = 0;
   * el.entanglement = 0.3;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-quantum-flux': GameQuantumFluxElement;
  }
}
