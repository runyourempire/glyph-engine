// GAME Component: aurora-drift — auto-generated, do not edit.
(function(){
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-aurora-drift: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-aurora-drift', AuroraDrift);
})();
