/**
 * GLYPH Component: living-landscape
...
/**
 * `<game-living-landscape>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GameLivingLandscapeElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-living-landscape': GameLivingLandscapeElement;
  }
}
