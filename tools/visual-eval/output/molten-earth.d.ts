...
/**
 * `<game-molten-earth>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-molten-earth heat="0" flow_speed="0.2"></game-molten-earth>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-molten-earth')!;
   * el.heat = 0;
   * el.flow_speed = 0.2;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-molten-earth': GameMoltenEarthElement;
  }
}
