/**
 * GLYPH Component: reaction-field
...
/**
 * `<game-reaction-field>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GameReactionFieldElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-reaction-field': GameReactionFieldElement;
  }
}
