...
/**
 * `<game-living-coral>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-living-coral current="0" bloom_cycle="0.4"></game-living-coral>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-living-coral')!;
   * el.current = 0;
   * el.bloom_cycle = 0.4;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-living-coral': GameLivingCoralElement;
  }
}
