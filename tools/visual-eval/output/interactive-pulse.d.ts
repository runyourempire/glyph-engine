/**
 * GLYPH Component: interactive-pulse
...
/**
 * `<game-interactive-pulse>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-interactive-pulse intensity="0.5"></game-interactive-pulse>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-interactive-pulse')!;
   * el.intensity = 0.5;
 * ```
 */
interface GameInteractivePulseElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-interactive-pulse': GameInteractivePulseElement;
  }
}
