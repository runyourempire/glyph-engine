...
/**
 * `<game-digital-consciousness>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-digital-consciousness awareness="0" processing="0.5"></game-digital-consciousness>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-digital-consciousness')!;
   * el.awareness = 0;
   * el.processing = 0.5;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-digital-consciousness': GameDigitalConsciousnessElement;
  }
}
