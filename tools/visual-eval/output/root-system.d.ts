...
/**
 * `<game-root-system>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-root-system color_r="0.2" color_g="1.2" color_b="0.3"></game-root-system>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-root-system')!;
   * el.color_r = 0.2;
   * el.color_g = 1.2;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-root-system': GameRootSystemElement;
  }
}
