// GAME Component: cyberpunk-rain — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    // ── Layer 1: city ──
    {
        ...
        let gx = abs(game_mod(p.x + 0.080000 * 0.5, 0.080000) - 0.080000 * 0.5) - 0.002000;
        let gy = abs(game_mod(p.y + 0.080000 * 0.5, 0.080000) - 0.080000 * 0.5) - 0.002000;
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-cyberpunk-rain: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-cyberpunk-rain', CyberpunkRain);
})();
