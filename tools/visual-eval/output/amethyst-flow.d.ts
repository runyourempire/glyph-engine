...
/**
 * `<game-amethyst-flow>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-amethyst-flow life="0" warmth="0"></game-amethyst-flow>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-amethyst-flow')!;
   * el.life = 0;
   * el.warmth = 0;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-amethyst-flow': GameAmethystFlowElement;
  }
}
