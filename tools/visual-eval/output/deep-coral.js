// GAME Component: deep-coral — auto-generated, do not edit.
(function(){
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-deep-coral: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-deep-coral', DeepCoral);
})();
