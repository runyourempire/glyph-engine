// GAME Component: prismatic-cascade — auto-generated, do not edit.
(function(){
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-prismatic-cascade: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-prismatic-cascade', PrismaticCascade);
})();
