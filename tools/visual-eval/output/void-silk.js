// GAME Component: void-silk — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    // ── Layer 5: stardust ──
    {
        ...
        p = vec2<f32>(game_mod(p.x + 0.140000 * 0.5, 0.140000) - 0.140000 * 0.5, game_mod(p.y + 0.140000 * 0.5, 0.140000) - 0.140000 * 0.5);
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-void-silk: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-void-silk', VoidSilk);
})();
