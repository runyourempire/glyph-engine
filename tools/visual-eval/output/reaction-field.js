// GAME Component: reaction-field — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    color_result = vec4<f32>(color_result.rgb * vec3<f32>(0.010000, 0.010000, 0.030000), color_result.a);
...
void main(){
    ...
    color_result = vec4(color_result.rgb * vec3(0.010000, 0.010000, 0.030000), color_result.a);
...
class ReactionField extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    const gpu = new GameRenderer(this._canvas, WGSL_V, WGSL_F, UNIFORMS, 'react');
    if (await gpu.init()) {
      this._renderer = gpu;
    } else {
      ...
      if (gl.init()) {
        ...
        console.warn('game-reaction-field: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-reaction-field', ReactionField);
})();
