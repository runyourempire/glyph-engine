...
/**
 * `<game-supernova>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-supernova detonation="0" shockwave="0"></game-supernova>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-supernova')!;
   * el.detonation = 0;
   * el.shockwave = 0;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-supernova': GameSupernovaElement;
  }
}
