...
/**
 * `<game-ocean-alive>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-ocean-alive life="0" warmth="0"></game-ocean-alive>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-ocean-alive')!;
   * el.life = 0;
   * el.warmth = 0;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-ocean-alive': GameOceanAliveElement;
  }
}
