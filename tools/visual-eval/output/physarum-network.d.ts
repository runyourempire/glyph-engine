/**
 * GLYPH Component: physarum-network
...
/**
 * `<game-physarum-network>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GamePhysarumNetworkElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-physarum-network': GamePhysarumNetworkElement;
  }
}
