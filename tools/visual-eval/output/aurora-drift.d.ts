...
/**
 * `<game-aurora-drift>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-aurora-drift solar_wind="0" curtain_wave="0" altitude="5"></game-aurora-drift>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-aurora-drift')!;
   * el.solar_wind = 0;
   * el.curtain_wave = 0;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-aurora-drift': GameAuroraDriftElement;
  }
}
