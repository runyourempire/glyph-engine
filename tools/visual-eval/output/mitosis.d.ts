...
/**
 * `<game-mitosis>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-mitosis color_r="1.5" color_g="0.15" color_b="0.15"></game-mitosis>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-mitosis')!;
   * el.color_r = 1.5;
   * el.color_g = 0.15;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-mitosis': GameMitosisElement;
  }
}
