...
/**
 * `<game-galactic-spiral>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-galactic-spiral spin="0.2" luminosity="0.4"></game-galactic-spiral>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-galactic-spiral')!;
   * el.spin = 0.2;
   * el.luminosity = 0.4;
 * ```
 */
...
declare global {
  interface HTMLElementTagNameMap {
    'game-galactic-spiral': GameGalacticSpiralElement;
  }
}
