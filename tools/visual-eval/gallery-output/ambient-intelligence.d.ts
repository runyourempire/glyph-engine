/**
 * GLYPH Component: ambient-intelligence
...
/**
 * `<game-ambient-intelligence>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GameAmbientIntelligenceElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-ambient-intelligence': GameAmbientIntelligenceElement;
  }
}
