...
/**
 * `<game-flow-diagram>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GameFlowDiagramElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-flow-diagram': GameFlowDiagramElement;
  }
}
