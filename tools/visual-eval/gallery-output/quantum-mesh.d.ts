...
/**
 * `<game-quantum-mesh>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GameQuantumMeshElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-quantum-mesh': GameQuantumMeshElement;
  }
}
