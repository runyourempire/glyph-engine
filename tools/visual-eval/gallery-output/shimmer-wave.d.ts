...
/**
 * `<game-shimmer-wave>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GameShimmerWaveElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-shimmer-wave': GameShimmerWaveElement;
  }
}
