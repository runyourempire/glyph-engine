...
/**
 * `<game-signal-meter>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-signal-meter strength="0.7"></game-signal-meter>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-signal-meter')!;
   * el.strength = 0.7;
 * ```
 */
interface GameSignalMeterElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-signal-meter': GameSignalMeterElement;
  }
}
