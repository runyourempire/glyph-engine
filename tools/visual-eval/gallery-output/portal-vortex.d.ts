...
/**
 * `<game-portal-vortex>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GamePortalVortexElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-portal-vortex': GamePortalVortexElement;
  }
}
