...
/**
 * `<game-rain-curtain>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GameRainCurtainElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-rain-curtain': GameRainCurtainElement;
  }
}
