...
/**
 * `<game-card-entrance>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-card-entrance reveal="0"></game-card-entrance>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-card-entrance')!;
   * el.reveal = 0;
 * ```
 */
interface GameCardEntranceElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-card-entrance': GameCardEntranceElement;
  }
}
