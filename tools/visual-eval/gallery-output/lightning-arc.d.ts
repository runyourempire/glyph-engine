...
/**
 * `<game-lightning-arc>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GameLightningArcElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-lightning-arc': GameLightningArcElement;
  }
}
