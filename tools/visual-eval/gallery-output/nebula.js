// GAME Component: nebula — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    // ── Layer 0: clouds ──
    {
        ...
        { let warp_x = fbm2(p * 2.500000 + vec2<f32>(0.0, 1.3), i32(5.000000), 0.600000, 0.300000);
        let warp_y = fbm2(p * 2.500000 + vec2<f32>(1.7, 0.0), i32(5.000000), 0.600000, 0.300000);
...
void main(){
    ...
    // ── Layer 0: clouds ──
    {
        ...
        { float warp_x = fbm2(p * 2.500000 + vec2(0.0, 1.3), int(5.000000), 0.600000, 0.300000);
        float warp_y = fbm2(p * 2.500000 + vec2(1.7, 0.0), int(5.000000), 0.600000, 0.300000);
...
class Nebula extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-nebula: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-nebula', Nebula);
})();
