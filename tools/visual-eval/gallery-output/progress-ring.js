// GAME Component: progress-ring — auto-generated, do not edit.
(function(){
...
`;
const UNIFORMS = [{name:'fill_angle',default:4}];
...
class ProgressRing extends HTMLElement {
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-progress-ring: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
  ...
  get fill_angle() { return this._renderer?.userParams['fill_angle'] ?? this._pendingParams['fill_angle'] ?? 4; }
...
customElements.define('game-progress-ring', ProgressRing);
})();
