/**
 * GLYPH Component: crystal-lattice
...
/**
 * `<game-crystal-lattice>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GameCrystalLatticeElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-crystal-lattice': GameCrystalLatticeElement;
  }
}
