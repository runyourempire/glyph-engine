/**
 * GLYPH Component: particle-swarm
...
/**
 * `<game-particle-swarm>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GameParticleSwarmElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-particle-swarm': GameParticleSwarmElement;
  }
}
