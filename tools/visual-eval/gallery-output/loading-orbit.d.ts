...
/**
 * `<game-loading-orbit>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 */
interface GameLoadingOrbitElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-loading-orbit': GameLoadingOrbitElement;
  }
}
